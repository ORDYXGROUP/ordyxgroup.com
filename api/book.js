...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px">
  ...
  <tr><td style="padding-bottom:8px">
    <h1 style="margin:0;font-size:28px;font-weight:300;color:#f0ebe0;line-height:1.25;letter-spacing:-.01em">New booking request.</h1>
  </td></tr>

  <tr><td style="padding-bottom:40px">
    <p style="margin:0;font-size:14px;color:#888;line-height:1.6">Review the request below and confirm or decline.</p>
  </td></tr>
  ...
  <tr><td style="padding-bottom:28px">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="padding:20px 0 0;border-top:1px solid #242424">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="width:50%;padding:0 20px 20px 0;vertical-align:top">
              <div style="font-size:9px;font-weight:600;letter-spacing:.15em;color:#666;text-transform:uppercase;margin-bottom:7px">Name</div>
              <div style="font-size:14px;color:#f0ebe0;font-weight:400">${name}</div>
            </td>
            <td style="width:50%;padding:0 0 20px 20px;vertical-align:top;border-left:1px solid #242424">
              <div style="font-size:9px;font-weight:600;letter-spacing:.15em;color:#666;text-transform:uppercase;margin-bottom:7px">Company</div>
              <div style="font-size:14px;color:#f0ebe0;font-weight:400">${company}</div>
            </td>
          </tr>
          <tr>
            <td style="width:50%;padding:16px 20px 0 0;vertical-align:top;border-top:1px solid #242424">
              <div style="font-size:9px;font-weight:600;letter-spacing:.15em;color:#666;text-transform:uppercase;margin-bottom:7px">Email</div>
              <div style="font-size:13px;color:#aaa;font-weight:400">${email}</div>
            </td>
            ${phone ? `<td style="width:50%;padding:16px 0 0 20px;vertical-align:top;border-top:1px solid #242424;border-left:1px solid #242424">
              <div style="font-size:9px;font-weight:600;letter-spacing:.15em;color:#666;text-transform:uppercase;margin-bottom:7px">Phone</div>
              <div style="font-size:13px;color:#aaa;font-weight:400">${phone}</div>
            </td>` : '<td style="border-top:1px solid #242424"></td>'}
          </tr>
          ${desc ? `<tr>
            <td colspan="2" style="padding:20px 0 0;border-top:1px solid #242424">
              <div style="font-size:9px;font-weight:600;letter-spacing:.15em;color:#666;text-transform:uppercase;margin-bottom:9px">Challenge / Context</div>
              <div style="font-size:13px;color:#aaa;line-height:1.75;white-space:pre-wrap">${desc}</div>
            </td>
          </tr>` : ''}
        </table>
      </td></tr>
  ...
  <tr><td style="padding-bottom:16px">
    <table cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td>
          <a href="${declineUrl}" style="display:inline-block;padding:12px 28px;background:transparent;color:#888;font-size:11px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;text-decoration:none;border:1px solid #333">Decline</a>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding-bottom:48px">
    <p style="margin:0;font-size:11px;color:#555;line-height:1.6">Confirming will automatically send the client a calendar invite.</p>
  </td></tr>

  <!-- Footer -->
  <tr><td style="border-top:1px solid #222;padding-top:24px">
    <p style="margin:0;font-size:11px;color:#555;line-height:1.8">ORDYX GROUP &nbsp;·&nbsp; Internal Notification</p>
  </td></tr>
